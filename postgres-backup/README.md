...
```bash
stackit postgresflex instance clone b7c0b458-38ac-4ada-89a3-9ebcee206089 --recovery-timestamp 2026-02-10T12:04:04+00:00
```
...
## Create a table and an entry
```sql
CREATE TABLE "abs-entries" (
    id SERIAL PRIMARY KEY,
    abc TEXT,
    createdAT TIMESTAMPTZ DEFAULT NOW()
);
INSERT INTO "abc-entries" (abc) VALUES ('A');
```
